  ...
  return (
    ...
    >
      ...
      <div
        ...
        onKeyDown={() => {}}
        className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-fit w-[480px] max-w-[95vw] bg-white dark:bg-[#121212] border border-slate-400 rounded-lg py-8 px-4 cursor-default"
      >
        <button
          onClick={toggle}
        ...
        <p className="text-center">
          ...
          ✉️ Send me an email
          <br />
          <b>cristian90.jesus &lt;at&gt; gmail &lt;dot&gt; com</b>
        </p>
      </div>
    </div>
  );
